...
function osaX(i) {
    ...
    let num = i % 10; // sweet sweet modulo
    console.log("left: " + num); // to mi dá 1 2 3 4 5 6 7 8 9 0
    ...
    return (
        <div className="Cursor frame">
            ...
            <div className="cursor-grid-container" ref={gridRef}></div>
